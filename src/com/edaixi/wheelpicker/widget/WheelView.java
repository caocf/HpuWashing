...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xFF111221,
			0x00AA22AA, 0x00AA22AA };
...
//		0x00AAAAAA, 0x00AAAAAA };
	...
	/**
	 * Sets is touchable value
	 * 
	 * @return the current touchable value
	 */
	...
	public void scroll(int itemsToScroll, int time) {
		LogUtil.e("设置滑动条目--------------到"+itemsToScroll);
