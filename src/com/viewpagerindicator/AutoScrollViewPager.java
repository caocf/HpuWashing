...
import com.viewpagerindicator.transforms.ABaseTransformer;
 ...
 * <li>{@link #setCycle(int)} set whether automatic cycle when auto scroll reaching the last or first item, default
 * is true</li>
...
public class AutoScrollViewPager extends ViewPager {
    ...
    //0:
    private Cycle                cycleType                     = Cycle.cycleLine;
     ...
     */
    public void setCycle(int isCycle) {
        switch (isCycle){
            case 0:
                this.cycleType = Cycle.reverse;
                break;
            case 1:
                this.cycleType = Cycle.cycleLine;
                break;
            case 2:
                this.cycleType = Cycle.once;
                break;
            default:
                this.cycleType = Cycle.reverse;
                break;
